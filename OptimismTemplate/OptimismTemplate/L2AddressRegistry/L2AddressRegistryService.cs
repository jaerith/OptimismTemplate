...
namespace OptimismTemplate.Contracts.L2AddressRegistry
{
    public partial class L2AddressRegistryService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, L2AddressRegistryDeployment L2AddressRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<L2AddressRegistryDeployment>().SendRequestAndWaitForReceiptAsync(L2AddressRegistryDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, L2AddressRegistryDeployment L2AddressRegistryDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<L2AddressRegistryDeployment>().SendRequestAsync(L2AddressRegistryDeployment);
        }

        public static async Task<L2AddressRegistryService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, L2AddressRegistryDeployment L2AddressRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, L2AddressRegistryDeployment, cancellationTokenSource);
            return new L2AddressRegistryService(web3, receipt.ContractAddress);
        }
        ...
        public L2AddressRegistryService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
